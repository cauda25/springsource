...
public class QueryDslOrderRepositoryImpl extends QuerydslRepositorySupport implements QueryDslOrderRepository {
    ...
    public List<Object[]> joinTest() {
        // select * from mart_order mo join mart_member mm on mo.member_id =
        // mm.member_id
        QMember qMember = QMember.member;
        ...
        // mm.MEMBER_ID LEFT JOIN MART_ORDER_ITEM moi ON mo.ORDER_ID =
        // moi.ORDER_ORDER_ID;
    ...
    public List<Object[]> subQueryTest() {
        ...
        JPQLQuery<Tuple> tuple = from(qOrder).join(qMember).on(qOrder.member.eq(qMember))
