...
@Log4j2
public class SearchBoardRepoditoryImpl extends QuerydslRepositorySupport implements SearchBoardRepoditory {

    public SearchBoardRepoditoryImpl() {
        super(Board.class);
    }

    @Override
    public List<Object[]> list() {
        log.info("Board + Reply + Member 정부 추출");
    ...
    public Page<Object[]> list(String type, String keyword, Pageable pageable) {
        ...
        sort.stream().forEach(order -> {
            ...
            PathBuilder<Board> orderByExpressoin = new PathBuilder<>(Board.class, "board");
